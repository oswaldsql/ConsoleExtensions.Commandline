...
namespace ConsoleExtensions.Commandline
{
	public class ModelMap
	{
		...
		{
			this.Flags = new ReadOnlyDictionary<string, ModelFlag>(flags.ToDictionary(s => s.Name, StringComparer.InvariantCultureIgnoreCase));
			this.Actions = new ReadOnlyDictionary<string, ModelAction>(actions.ToDictionary(s => s.Name, StringComparer.InvariantCultureIgnoreCase));
		}
