...
namespace ConsoleExtensions.Commandline.Converters
{
    ...
    public interface IValueConverter
    {
        ...
        string ToString(object source, ICustomAttributeProvider customAttributeProvider);
        ...
        object ToValue(string source, Type type, ICustomAttributeProvider customAttributeProvider);
